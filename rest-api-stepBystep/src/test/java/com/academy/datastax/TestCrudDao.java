...
import com.academy.datastax.dao.CommentDseCrudRepository;
import com.datastax.driver.dse.DseSession;

@ExtendWith(SpringExtension.class)
@ContextConfiguration(
        classes= { DseConfiguration.class, CommentDseCrudRepository.class })
@TestPropertySource(
...
public class TestCrudDao {
    ...
    @Autowired
    private CommentDseCrudRepository dao;
