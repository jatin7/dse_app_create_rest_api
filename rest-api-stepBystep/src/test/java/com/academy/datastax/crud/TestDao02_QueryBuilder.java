...
import com.academy.datastax.dao.CommentDao02_QueryBuilder;
import com.datastax.driver.dse.DseSession;

@ExtendWith(SpringExtension.class)
@ContextConfiguration(
        classes= { DseConfiguration.class, CommentDao02_QueryBuilder.class })
@TestPropertySource(
        locations = { "classpath:application-test.properties"})
public class TestDao02_QueryBuilder {
    ...
    @Autowired
    private CommentDao02_QueryBuilder dao;
